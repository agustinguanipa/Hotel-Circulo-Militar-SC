...
<body>
  ...
  <table class="table table-bordered table-striped table-active"  style="margin-top: 70px;">
  	<tr><!--la del titulo-->
        <td colspan="12" align="center" style="background-color: #4f99fe !important;"  class="table-borderless bg-dark "><h4><b class="text-white">Consulta de pagos</b></h4></td>
      </tr>

      <tr id="elnegronolada" class="bg-light col-12">
       
        <td align="center" class="text-dark text-wrap  text-center"><b>Fecha</b></td>
      ...
      <tr>
        <tr id='elnegronolada' class='bg-faded col-12'>
          ...
          <td align='center' class='text-dark'><b>$rusu[fecha]</b></td>
