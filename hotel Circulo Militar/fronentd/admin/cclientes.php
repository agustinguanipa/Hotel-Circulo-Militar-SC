...
<div class="container" >
  ...
  <table colspan="13" class="table table-bordered table-striped table-active"  style="margin-top: 70px;">
  	<tr><!--la del titulo-->
        <td colspan="13" align="center" 
style="background-color: #4f99fe !important;"  class="table-borderless bg-dark "><h4><b class="text-white">Consulta de clientes</b></h4></td>
      </tr>

      <tr id="elnegronolada" class="bg-light col-13">
        ...
        <td align="center" class="text-dark text-wrap  text-center"><b>Tipo</b></td>
        ...
        <td align="center" class="text-dark text-edit  text-center"><b>Modificar</b></td>
      ...
      <tr>
        <tr id='elnegronolada' class='bg-faded col-12'>
          ...
          <td align='center'><a href='../../backend/delcli.php?ced=".$rusu['ced_per']."'><i  class='fas fa-trash text-danger'></i></a></td>
          <td align='center'><a href='../../backend/updcli.php?ced=".$rusu['ced_per']."'><i  class='fas fa-edit text-success'></i></a></td>
