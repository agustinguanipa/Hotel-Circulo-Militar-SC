...
<body data-dark>
  ...
  <div class="col-md-9" >
    <label for="ced" class="form-label text-center" >Cliente</label>
    <input type="text" class="form-control" id="ced" name="ced" placeholder="Cedula de identidad" maxlength="9" required>
  </div>
 
  <div class="col-md-9" >
    <label for="ced" class="form-label text-center" >Dias</label>
    <input type="number" class="form-control" id="days" placeholder="00" name="days" required>
  </div>
  ...
  <div class="col-12 pt-4" >
    <button type="submit" class="btn-lg btn-primary col-7" id="enviar" name="enviar">Guardar <i class="fas fa-save"></i></button>
  </div>
</form>
</div>
