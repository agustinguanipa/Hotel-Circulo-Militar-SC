  ...
  include 'menudesplegable.php'; ?>
    ...
    <?php  include '../../backend/exhabi.php'; 
              ...
              { 
                ...
                {
                 echo 
                "<div class='col-1 pt-lg-4'>
                <a href='opcdisp.php?cod=$vc[id]'>
                <div class='card h-100'>
                 <img src='../img/hotelh.jpg' class='card-img-top ' alt='clientes'>
                ...
                if($vc['sta_hab']=="O")
                {
                  echo "<div class='col-1 pt-lg-4'>
                <a href='opcocup.php?cod=$vc[id]' title='Agregar Reservacion'>
                <div class='card h-100'>
                <img src='../img/hoteloc.png' class='card-img-top ' alt='clientes'>
                ...
                <div class='card h-100'>
                <img src='../img/hotelm.jpg' class='card-img-top ' alt='clientes'>
                ...
                <div  class='card h-100'>
                 <img src='../img/fuera1.jpg' class='card-img-top ' alt='clientes'>
