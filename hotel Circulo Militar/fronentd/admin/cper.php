...
session_start();
  ...
  if (!$_GET) {
  header('location:cper.php?pagina=1');
}
...
<body>
	<?php include 'navb2.php';
  ?>

  <div class="container">
  <table class="table table-bordered table-striped table-active"  style="margin-top: 70px;">
  	<tr><!--la del titulo-->
        <td colspan="12" align="center"  style="background-color: #4f99fe !important;" class="table-borderless bg-dark "><h4><b class="text-white">Consulta Personal</b></h4></td>
      </tr>
      ...
      <tr id="elnegronolada" class="bg-light col-12">
        ...
        <td align="center" class="text-dark text-wrap  text-center"><b>Cargo</b></td>
   ...
   <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <a class="page-link" href="cres.php?pagina=<?php echo $_GET['pagina']-1 ?>" aria-label="Previous">
            ...
            for ($i=0; $i <$paginas ; $i++): 
            ?>
            <li class="page-item <?php echo $_GET['pagina']==$i+1? 'active' : ''  ?>"><a class="page-link" href="cres.php?pagina=<?php echo $i+1;  ?>"><?php echo $i+1;  ?></a></li>
            <?php endfor; ?>
            <li class="page-item <?php echo $_GET['pagina']>=$paginas? 'disabled' : ''  ?>">
      <a class="page-link" href="cres.php?pagina=<?php echo $_GET['pagina']+1 ?>"  aria-label="Next">
