...
<body data-dark>
  ...
  <div class="col-3" style="margin-left: 200px; margin-top: 30px;">
    <a href="../../backend/habihorep.php?cod=<?php echo $_REQUEST["cod"]; ?>" title="Habilitar">
    <div class="card h-100">
      <img src="../img/agregar.jpg" class="card-img-top " alt="clientes">
      <div class="card-body">
        <h5 class="card-title text-center">Terminar ocupacion <i class="fas fa-plus-circle"></i></h5>
      </div>
    </div>
  </a>
  </div>
...
<!-- carta consulta -->
  <div class="col-3" style="margin-top: 30px;">
    <a href="../../backend/manhab.php?cod=<?php echo $_REQUEST["cod"]; ?>" title="Mantenimiento">
    <div class="card h-100">
  ...
  <!-- carta consulta -->
  <div class="col-3" style="margin-left: 390px;">
    <a href="habser.php?cod=<?php echo $_REQUEST["cod"]; ?>" title="Servicios">
    <div class="card h-100">
      <img src="../img/listar.jpg" class="card-img-top " alt="Consultar usuarios">
      <div class="card-body">
        <h5 class="card-title text-center">Gestion de servicios <i class="fas fa-clipboard-list"></i></h5>
      </div>
    </div>
      </a>
  </div>
