...
<div class="container" >
  ...
  <table colspan="12" class="table table-bordered table-striped table-active"  style="margin-top: 70px;">
  	<tr><!--la del titulo-->
        <td  style="background-color: #4f99fe !important;" colspan="12" align="center" class="table-borderless bg-dark "><h4><b class="text-white">Consulta de clientes</b></h4></td>
      </tr>
