...
<body >
	<nav class="navbar navbar-expand-lg navbar-dark" style=" background: #3FBCE7 linear-gradient(
180deg
,#3FBCE7,#4A51D3);" >
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
         <input type="button" class="btn btn-outline-light" value="Inicio" onclick=" relocate_home()">
        </li>
      <li>
      <a  class="btnteam luz text-dark btn btn btn-outline-secondary" role="button" data-bs-toggle="button" aria-pressed="true">🌙</a>
      </li>
