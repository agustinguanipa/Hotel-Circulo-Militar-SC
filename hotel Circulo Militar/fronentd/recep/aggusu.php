...
<body data-dark>
  ...
  <form class="row g-3" action="../../backend/aggusu.php" method="POST">
    <!--primera fila-->
  <div class="col-md-3">
  ...
  <div class="col-12 pt-4" align="center">
    <button type="submit" class="btn-lg btn-dark col-7" id="enviar"  name="enviar" >Registrar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
