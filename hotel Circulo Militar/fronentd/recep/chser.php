...
<div class="container">
  <table class="table table-bordered table-striped table-active"  style="margin-top: 70px;">
  	<tr><!--la del titulo-->
        <td colspan="12" align="center"  style="background-color: #4f99fe !important;" class="table-borderless bg-dark "><h4><b class="text-white">Consulta de servicios habitacion <?php echo $_REQUEST["cod"]; ?></b></h4></td>
      </tr>
