...
<body class="bg-light" background="fronentd/img/ff.jpg">
	<section>
		...
		<div class="row g-0">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      ...
						      <div class="carousel-caption d-none d-md-block">
						        <h5></h5>
						        <p>Una experiencia nueva e inolvidable.</p>
						      </div>
						    </div>
			...
			<div class="col-lg-5  flex-column align-items-end min-vh-100">
				...
				<div class="px-lg-5 py-lg-4 p-4 w-100  align-self-center">
					<h1 class="text-dark font-weight-bold mb-4">Circulo Militar</h1>
					<form action="backend/login.php" method="POST">
					  <div class="mb-3">
					    <label for="exampleInputEmail1" class="form-label font-weight-bold text-dark">Usuario</label>
