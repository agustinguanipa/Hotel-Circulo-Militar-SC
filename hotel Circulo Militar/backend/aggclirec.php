...
if (isset($_POST["enviar"])) {
	...
	if ($ip && $iu) {
		...
		echo "<script>location.href='../fronentd/recep/cclientes.php';</script>";
	}
	else
	{
		echo"<script>alert ('Cliente ya existe por favor intente nuevamente');</script>";
           echo "<script>location.href='../fronentd/recep/clientes.php';</script>";
	}
}
