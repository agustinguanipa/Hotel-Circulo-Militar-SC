		...
		<div id="pantalla" class="col-md-10 all">
			<div class="container">
				...
				<div class="row row-cols-1 row-cols-md-3 g-4" style="padding-top: 50px;">
					...
					<!-- carta reservaciones -->
					<div class="col-4">
						<a href="reservas.php" title="reservaciones">
							<div class="card h-100">
					...
					<!-- Grid row-->
						...
						<div class="row d-flex text-center justify-content-center mb-md-0 mb-4">
							...
							<div class="col-md-8 col-12 mt-5">
								...
								accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur.</p>
							</div>
							<!-- Grid column -->
