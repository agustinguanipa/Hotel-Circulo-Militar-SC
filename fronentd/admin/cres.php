...
session_start();
  ...
  if (!$_GET) {
  header('location:cres.php?pagina=1');
}
...
<body>
	<div class="row">
		...
		?>
		<div id="pantalla" class="col-md-10 all">

			  <table class="table table-bordered table-striped table-active"  style="margin-top: 70px;">
			  	<tr><!--la del titulo-->
			        <td colspan="12" align="center" class="table-borderless bg-dark "><h4><b class="text-white">Consulta de reservaciones</b></h4></td>
			      </tr>
