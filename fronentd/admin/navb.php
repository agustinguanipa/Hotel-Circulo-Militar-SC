	...
	<body>
		<nav id="banner" class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container-fluid">
				<a class="navbar-brand" href="prinadmin.php">
					<img src="../img/logo_sinf.png" width="46" height="33" class="d-inline-block align-top" alt="">
				</a>
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown sini">
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								<li>
									<a class="dropdown-item" href="../../backend/destructordesesssiones.php">Cerrar session</a>
								</li>
							</ul>
						</li>
					</ul>
